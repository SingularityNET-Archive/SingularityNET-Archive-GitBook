...
- Treasury Guild Feedback Relayed by Kizzy: Add a second dashboard for Budget Planner or resource tracking in the Treasury Guild’s meeting room.
Add both Treasury Guild session times and Treasury Operations call times to the dashboard displaying the meeting date and time.
Information in the dialogue system is outdated and needs to be updated.
