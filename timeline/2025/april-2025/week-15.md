...
- **Type of meeting:** Weekly
- **Present:** PeterE [**facilitator**], CallyFromAuron [**documenter**], PeterE, CallyFromAuron, Tevo, Duke, Effiom, UKnowZork, martinsoki, CJFrankie, others unknown
- **Purpose:** regular weekly Open Governance session. This meeting was the official retrospective on the budget consent process for Q2 2025.
- **Working Docs:**
  - [Q2 2025 budget consent process retrospective (Miro board)](https://miro.com/app/board/uXjVLtid06I=/)
  - [GovWG rolling agenda](https://docs.google.com/document/d/1t39dwlwLYYB_1z_5szq1rnOH7mVTHe8Tmwv0R6ELOyE/edit?usp=sharing)

#### Narrative:
This meeting was the official retrospective on the budget consent process for Q2 2025 - see the Miro board https://miro.com/app/board/uXjVLtid06I=/

Key points:
General:
- Non-anonymity - some found it positive, others didn't. Hard to tell if people are witholding opinions because of it, so we probably need to ask people.

WENT WELL:
- Removal of self-nomination: no issues were noticed
- Each WG writing a dedicated doc to respond to objections seems to work - we could ask people to start writing those docs straight after Round 1
- It worked well to not allow any new objections in Round 2
- Quarterly reports are improving
- Our budgets are small, which minimiuses the tensions in the budget process
- Budget caps is still reducing the time spent on the consent proocess, and working well
- Deadlines went well - people got budgets in on time

DIDN'T GO WELL:
- Process of addressing objections could be improved. Reading objections out in a meeting is not very engaging; but if we discuss objections in a meeting, we used entire meeting time to address objections on just one WG. And asynchronous processes are not working smoothly. 
- After the first round there were too many meetings before we progressed to next stage
- Much lower numbers of Core Contributors taking part compared to usual - aound 16 people?. 
- How we treat abstentions - people are using them as a "soft object" but we're ignoring abstentions completely. Is non-anonymity a factor - are peoople abstaining because they don't feel comfortable to object when everyone knows who they are?
- Feels like we are not really encouraging objections - we rushed through them, and there was some almost "eyerolling"
- The process has no teeth - whatever objections are made, people get their budgets (although perhaps that's the right approach?) This might be an effect of the 80/20% rule - nobody is likely to get 20% objection, especially not when people abstain rather than objecting
- Budgets seem detached from reports
- Relevant actions or assets are not included in Quarterly or Budget Reports
- Using USD value for rewarding tasks - it has an impact in volatile market
- Some WGs' budgets don't improve over iterations - the budget items don't change that much in detail after a few iterations

SUGGESTIONS
- We need to ask people who did not take part, why they didn't - and whether no anonymity was a factor
- Implement a quorum?
- Find clearer ways to track objections
- Reassess what "I abstain" means - maybe ask in the form itself why people are abstaining
- Look at whether we have a climate where it feels safe to object / what we could do to make it feel safer
- Refine the consent form so that it's clear what people's objection is, so we can let go of the idea that objectors need to be present in order for us to discuss the objection
- proposal budgets should match more with reports - more clarity on what we are measuring and why
- budget sheets themselves need more detail.
- Should we use the 80/20% rule for the first round of objections as well as the 2nd round?


As this is a retrospective, people simply shared their perspectives, and there were no decisions made; but in the "Decision" section below are things we agreed to discuss further in Governance meetings


#### Discussion Points:
- Non-anonymity and its effect on the process
- Process of tracking oobjections
- Abstentions - what do they mean and should we be tracking them?
- Clarity of reporting and budget sheets; and linking reports to budgets
- Possible negative effects of calculating budgets in USD
- Levels of participation
- Creating an environment where it is "safe" to object
- Should we implement a quorum?

#### Decision Items:
- We agreed to add the following topics to the schedule for Governance WG:

- Whether to implement a quorum
- Non-anonymity, and how to find out hoow people feel about it
- Better tracking of objections, especially from Quarter to Quarter
- Meaning of abstention, why people abstain, and whether we should be tracking abstentions or inferring anything from them
- The 80/20% rule
- 
  - [**rationale**] so they can have fuller discussion
  - [**effect**] affectsOnlyThisWorkgroup

#### Action Items:
- [**action**] Vani to add the agreed topics to the rolling agenda doc for GovWG [**assignee**] CallyFromAuron [**due**] 18 April 2025 [**status**] todo

#### Keywords/tags:
- **topics covered:** Consent Process, Abstentions, 80% / 20% rule, quarterly reporting, AGIX or USD, Anonymity, quorum, tracking objections, Participation in governance, Core Contributors , Budget caps, Budget deadlines
- **emotions:**  Collaborative, Interesting, Openness,  insightful
