---
description: Mon 3rd Nov - Sun 9th Nov 2025
---
...
- **Working Docs:**
  - [Sentiment Survey v3 - November 2025](https://docs.google.com/forms/d/e/1FAIpQLSfO3Xz1EfMwQj0s91i7aHGna9Ml-k02MZ4-bsaO7BgHfcZLNw/viewform)
  - [GovWG budgets](https://docs.google.com/spreadsheets/d/1DeUB6ytoOeG6SOHwhJxe-vII_mXmkjdxG1iD-f5B2Sc/edit?usp=sharing)
  - [draft report template for Q4 2025 workgroup reports](https://docs.google.com/document/d/1cf4Rlw-nwp2UXNNW16ZeYuhIxM_VbTowkbvrfOeHtOk/edit?usp=sharing)
  - [TEMPLATES - Progress Reports (Treasury Guilkd and Treasury Automation)](https://docs.google.com/document/d/1UgxHLwrlIBgqgRzG1PgfPut67IpbAMLaSlkVTDNukhQ/edit?usp=sharing)

#### Narrative:
1) WG budget adjustments due to low token price

No payments have been made yet this Quarter due to falling token prace.
We previously did a "budget-fitting" in which we agreed to reduce payments for documentation from $20 to %15, but token price is now so low that even this is unaffordable. 
We also need to clarify whether we will pay facilitators - currently we cannot afford to do so in USD, even if we (as previously agreed) do take the 1,500 AGIX that was left unallocated when we worked out the Q4 budget caps.
...
Currently documentation of GovWG meetings is quite poor, with decisions often not being accurately captured. A lot of correction is needed, and Vani no longer has time to do it.
Perhaps the low standards are due to low pay?
Suggestion - we will try having a live, collaborative doc during the meeting itself, where everyone can take part in keeping notes; then the documenter only needs to add it to the summary tool.
Or we could keep notes in the Zoom Chat.



3) Reporting template for Q4 2025 quarterly reports

We have agreed that there will be no budget consent process this Quarter, and only minimal reporting.
Vani drafted a template for minimal Q4 reports that can be added to the Governance Dashboard, and Guillermo has said this probably can be added to the Dashboard in time for the end of the Quarter.
But Tevo and Alfred have done considerable work on how they want to report for Treasury Guild and Treasury Automation, using a template that gives more detailed info.
We agreed that this template shouldn't be used for all WGs, as it's a bit too detailed and would remove the advantage of minimising the reporting overhead for WGs; but we agreed there needs to be an option for Treasury WGs to add their full reports as a doc.
We also agreed to ask WGs to list work that they planned but *didn't* do this Quarter - this will almost certainly be due to low token price, and will help quantify how much work is hindered by token price fluctuations.



4) Finalise sentiment survey design
...
- impact
- transparency
as we felt these were the priority issues that we wanted to know about.
...
5) Sentiment survey distribution
We agreed on posting in Ambassador-General and Decision-To-Be-Made Discord channels for the first week;
and then in the 2nd week, Peter and Vani will DM Core Contributors who haven't yet responded  
