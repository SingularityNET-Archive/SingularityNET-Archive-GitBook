...
&#xNAN;**\[Action]** - Fly will try to use [https://infranodus.com/](https://infranodus.com/) tool to see if it can help organize our documents\
...
&#xNAN;**\[Action]** The reward amount is increased to 20$/h\
&#xNAN;**\[Action]** Next call we will further analyze resources.
...
&#xNAN;**\[Action]** - Create a dedicated place for sharing only Decisions\
...
#### 1. Quick check of [Getting Started doc](https://docs.google.com/document/d/1q4dhediWgcbgAP3Wfsky_-roVyfCUe6xi-dhBdHbU4s/edit?usp=sharing)
...
&#xNAN;**\[decision]** We settled on Infographics and threads.
