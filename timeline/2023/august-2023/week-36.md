...
&#xNAN;**\[Action]** - Go over lessons with the thought of simplest action we could use for each lesson.\
&#xNAN;**\[Decision]** - we look at Dework tasks next meeting (Dework didn't work)
...
&#xNAN;**\[Decision]** - The result is ready for adoption\
&#xNAN;**\[Decision]** - Seed Workgroup does not require a roadmap\
&#xNAN;**\[Decision]** - If goals are longer than 3 months, there have to be milestones in the roadmap\
...
&#xNAN;**\[Decision]** - We will take a small break and skip next week\
&#xNAN;**\[Action]** - Coordinate a new Process Modeling Workgroup meeting time   [https://www.when2meet.com/?21161533-9RDo9](https://www.when2meet.com/?21161533-9RDo9)

#### **3) How do we evaluate Workgroups?**

**Description** - We have decided rules to analyze our results, but we have not described how.\
&#xNAN;**\[Decision]** - We may start documenting guides on the day we start evaluating any workgroup based on proposals\
...
&#xNAN;**\[Action]** - provide simple guidelines or steps to take to evaluate workgroups
