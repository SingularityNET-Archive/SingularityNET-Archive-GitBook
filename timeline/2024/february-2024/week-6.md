...
- Present: Tevo [facilitator], Tevo [documenter], Tevo, André, Peter, lord kizzy
- Purpose: Aggregating Ambassador Program assets and relevant information under GitBook
- Meeting video: https://miro.com/app/board/uXjVN-9yivE=/?moveToWidget=3458764574355478962&cot=10
- Miro board: https://miro.com/app/board/uXjVN-9yivE=/?moveToWidget=3458764574355478962&cot=10
- Other media: https://app.dework.xyz/singularitynet-ambas/process-guild
- Working Docs:
...
- Meeting video: https://youtu.be/ZSofwygwiDU
...
- Other media: https://youtu.be/HNvBpBYv68o
- Working Docs:
...
#### Action Items:
- [action] Document a Clear list of rules to create the contributor list [status] todo
- [action] Create a contributor list based on those rules [assignee] Tevo [status] todo
...
#### Action Items:
- [action] Update the Budget Calculator Document with reasons or sources why the request is not approved [assignee] Tevo [status] done
- [action] Explain Gamers Guild budget request changes to Gamer Guild leads [assignee] Tevo [status] done
