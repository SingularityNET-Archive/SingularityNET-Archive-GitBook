...
- Working Docs:
  ...
  - [Writer's workgroup evaluation Doc](https://docs.google.com/forms/d/e/1FAIpQLSdiAyiWjXjiUYLd7iGEvaEFqC8KsSVRQR-diZTevVAaoYTZBw/viewform)
...
- Type of meeting: Weekly
- Present: Kenichi [facilitator], Cjfrankie  [documenter], Kenichi, Cjfrankie, Mikasa, LadyTempestt, Kareem, devon, Ines, Nengi, kateri, Slate, lord kizzy, Gorga Siagian, Ayo
- Purpose: Announcing the lauch of the Medium publication; points system performances from May; updates from the Zealy side of things.
- Other media: [Link](https://help.medium.com/hc/en-us/articles/213904978-Add-a-draft-or-post-to-publication#:~:text=You%20will%20be%20listed%20as)
- Working Docs:
  - [Zealy Structure and Threshold](https://docs.google.com/document/d/11OpgPAPgd39rCuSg7yneu9Swt5jnNsYwmvLhAGSSe5Y/edit?usp=sharing)

#### Narrative:
Kickoff: The meeting started with Kenichi welcoming everyone to the meeting. Then he highlighted the agenda.
Kenichi announced the launch of the long-awaited Medium publication and how it will help writers get their articles published.

Then Kenichi stated that writers could submit articles to the publication while the Scribes took on the review before they get published on Medium.

Following that, Kenichi shared insights into the points system performance from May while also applauding the Scribes for their hard work towards Zealy guest reviews.

Kenichi shared insider tips on the Zealy structure and thresholds; from a birds-eye view, more dazzling rewards are up for grabs (such as merchandise, which will be sent to the winners in their respective locations).

Inés suggested that writers should add their names to every article they publish on the community page.

Ayo shared his concerns about the need for a structured meeting agenda; he also stated that people can't see meeting summaries after meetings; Kenichi cleared the air and pointed out that the WWG channel is private.

Slate and LordKizzy’s presence was felt as they discussed video WG, and WWG collaboration on Zealy.

Discussion on the Pupil tag.

Discussion on adding the writers to Notion while allowing them to use the brand assets to make graphics for their articles.



#### Decision Items:
- We decided that Devon would be added as a reviewer on Zealy to review quests from the video WG side.
  - [rationale] The video WG chose Devon because he is an active member in both video and writers WG.
  - [effect] mayAffectOtherPeople
- We decided that people with the Pupil tag will be able to track the WG channel progress, and see the conversations and meeting summaries.
  - [rationale] To keep everyone abreast of the latest updates and workgroup progress.
  - [effect] mayAffectOtherPeople
- We decided that writers should add their names to every article they publish on the community page to foster recognition.
  - [rationale] To foster a sense of recognition.
  - [effect] affectsOnlyThisWorkgroup
- We decided that the Scribes should be on the lookout for new people who might be interested in joining the WWG and then follow up with onboarding them by taking the WWG test.  
  - [rationale] To make onboarding a bit faster and more effortless for Kenichi.
  - [effect] affectsOnlyThisWorkgroup

#### Action Items:
- [action] Kenichi to add the writers to the Notion board. [assignee] Kenichi [status] todo
- [action] Kenichi to update the WWG Zoom meeting link. [assignee] Kenichi [status] todo
- [action] Inés to chase Mikasa to get insider tips on managing the Spanish X page. [assignee] Ines [status] in progress
- [action] Kenichi to add Devon to the Zealy review team to review the video WG quests. [assignee] Kenichi [status] in progress
- [action] Writers should share their emails on the channel so they get added to Notion and also have access to the brand assets. [status] in progress

#### Keywords/tags:
- topics covered: Points system, Q3 budget, Notion, Zealy, Triva, Onboarding, Task creator, brand assets, social media management, Medium publications, community page, attribution, Scribes, onboarding, Pupil
- emotions: Welcoming, insightful, interactive