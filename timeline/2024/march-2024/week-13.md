...
* Working Docs:
  * [Project Feedback Proposal: COLLABORATION SKILLS DATABASE \_ 150224](https://docs.google.com/document/d/1a\_q2yq1jrLSUiPzIfADZSsOcV3za7PBPY\_XXsCg8AS0/edit)
...
* Discussions on Updates on projects (TECHNICAL UPDATES from Rojo and Curtis)
* Discussions on Archiving process for the work group
* Discussions on projects management and the use of GitHub

#### Decision Items:

* We decided to use GitHub for project management.
  * \[rationale] Some members felt Dework is best used for task management and not project management, so the use of both GitHub and Dework could be integrated in the Guild
  * \[effect] affectsOnlyThisWorkgroup
...
* \[action] Guillermo to assist the other teams to get some deliverables \[assignee] Guillermo \[due] 3 April 2024 \[status] todo
* \[action] Rojo to create a GitHub account for the group \[assignee] Rojo \[due] 3 April 2024 \[status] todo
...
* Type of meeting: Weekly
* Present: Slate \[facilitator], hogantuso \[documenter], lord kizzy, malik, Slate, Rojo, hogantuso, devon, Zalfred, oep, Photogee, osmium, killy, lilycupcake, Prime, cardano\_class, Cjfrankie
...
* \[action] New Lead on Town Hall Summary \[assignee] cardano\_class \[due] 26 April 2024 \[status] in progress
...
Discussion on topics including: Workgroup iterations Animation / Scripting Questions inside of Onboarding WG on Roblox Budget Request for Q2
...
* And also mentioned that the budget would be increased from 1_200 = 200$ for 1 Workgroup so for 7_200 = 1400$ for 7 Workgroups for next quarter
